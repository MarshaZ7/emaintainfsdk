...
<!-- CTA Section -->
<section id="faq-cta" class="section light-background">

    <div class="container text-center"
         data-aos="fade-up">
        <h2>Have a Facility Problem?</h2>
        <p>
            Log in to e-Maintain@FSDK and submit your complaint
            to help us maintain a better learning environment.
        </p>
